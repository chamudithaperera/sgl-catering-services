...
async function main() {
  ...
  await prisma.$transaction([
    prisma.cateringMenu.deleteMany(),
    prisma.cateringCatergory.deleteMany(),
  ...
  const weddingCategory = await prisma.cateringCatergory.create({
    data: {
      title: "විවාහ උත්සව",
      shortLabel: "Wedding",
  ...
  const familyCategory = await prisma.cateringCatergory.create({
    data: {
  ...
  const corporateCategory = await prisma.cateringCatergory.create({
    data: {
      title: "ආයතනික උත්සව",
  ...
  await prisma.rentalBundle.createMany({
    data: [
      {
